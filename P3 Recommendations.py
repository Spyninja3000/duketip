...
movieData = np.loadtxt('./ml-100k/u.item', dtype={'names': ('userID', 'movieID', 'rating'), 'formats': (np.int, np.int, np.int)},
                       delimiter='\t', usecols=(0, 1, 2))  # TODO replace 0 with the correct cod eto load the movie data
